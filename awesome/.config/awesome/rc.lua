...
client.connect_signal("manage", window.manage_compton_shadow)
client.connect_signal("property::floating", window.manage_compton_shadow)
client.connect_signal("request::geometry", window.manage_compton_shadow)
